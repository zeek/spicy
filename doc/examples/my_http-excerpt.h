...
namespace hlt_my_http::MyHTTP::RequestLine {
    ...
    extern auto parse2(::hilti::rt::ValueReference<$hlt_my_http::MyHTTP::RequestLine>& __unit, ::hilti::rt::ValueReference<::hilti::rt::Stream>& __data, const std::optional<::hilt>
