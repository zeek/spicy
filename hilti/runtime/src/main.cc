...
// On MSVC, __declspec(selectany) does not apply to functions, but since
// main.cc is compiled into a static library, MSVC's linker will naturally
// prefer user-provided definitions over library symbols.
#ifdef _MSC_VER
int hilti::main(int argc, char** argv) {
#else
...
#ifdef _MSC_VER
int main(int argc, char** argv) try { return hilti::main(argc, argv); } catch ( const std::exception& e ) {
#else
