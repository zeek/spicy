...
public:
    ...
    auto ctorError(std::string v, const Meta& meta = {}) { return hilti::ctor::Error::create(context(), v, meta); }
    ...
    auto ctorSet(Expressions exprs, const Meta& meta = {}) { return hilti::ctor::Set::create(context(), exprs, meta); }
    ...
    auto statementBlock(Meta meta = {}) { return hilti::statement::Block::create(context(), meta); }
    auto statementBlock(Statements stmts, Meta meta = {}) {
        return hilti::statement::Block::create(context(), stmts, meta);
    }
    auto statementBreak(Meta meta = {}) { return hilti::statement::Break::create(context(), meta); }
    ...
    auto statementContinue(Meta meta = {}) { return hilti::statement::Continue::create(context(), meta); }
    ...
    auto statementReturn(Meta meta = {}) { return hilti::statement::Return::create(context(), meta); }
    ...
    auto statementThrow(Meta meta = {}) { return hilti::statement::Throw::create(context(), meta); }
    ...
    auto statementYield(Meta meta = {}) { return hilti::statement::Yield::create(context(), meta); }
    auto typeAddress(const Meta& m = Meta()) { return hilti::type::Address::create(context(), m); }
    auto typeAny(Meta m = Meta()) { return hilti::type::Any::create(context(), m); }
    ...
    auto typeError(Meta meta = {}) { return hilti::type::Error::create(context(), meta); }
    ...
    auto typeInterval(Meta meta = {}) { return hilti::type::Interval::create(context(), meta); }
    ...
    auto typeMember(const ID& id, Meta meta = {}) { return hilti::type::Member::create(context(), id, meta); }
    ...
    auto typeNetwork(Meta meta = {}) { return hilti::type::Network::create(context(), meta); }
    auto typeNull(Meta meta = {}) { return hilti::type::Null::create(context(), meta); }
    ...
    auto typePort(Meta meta = {}) { return hilti::type::Port::create(context(), meta); }
    auto typeReal(Meta meta = {}) { return hilti::type::Real::create(context(), meta); }
    auto typeRegExp(Meta meta = {}) { return hilti::type::RegExp::create(context(), meta); }
    auto typeResult(const QualifiedTypePtr& t, Meta m = Meta()) { return hilti::type::Result::create(context(), t, m); }
    ...
    auto typeString(Meta meta = {}) { return hilti::type::String::create(context(), meta); }
    ...
    auto typeTime(Meta meta = {}) { return hilti::type::Time::create(context(), meta); }
    ...
    auto typeUnknown(Meta meta = {}) { return hilti::type::Unknown::create(context(), meta); }
    ...
    auto typeVoid(Meta meta = {}) { return hilti::type::Void::create(context(), meta); }
