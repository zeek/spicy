 ...
 * resolver. This can be run on any subpart of the AST. It assumes
 * that expressions and types have already been resolved except for
 * coercions. This makes as many passes over the AST as needed until
 * all possible coercions have been applied.
 *
