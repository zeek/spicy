 ...
 * nodes it applies to.
 */
static std::unordered_map<node::Tag, std::unordered_set<Attribute::Kind>> allowed_attrs{
    {node::tag::Function,
...
void validator::VisitorMixIn::checkNodeAttributes(node::Tag tag, AttributeSet* attributes,
