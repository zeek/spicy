...
void cxx::Linker::finalize() {
    ...
    unit->add(fmt("const char HILTI_EXPORT HILTI_WEAK * $hlt_hlto_library_version = R\"(%s)\";", version.toJSON()));
    unit->add("const char HILTI_EXPORT HILTI_WEAK * $hlt_hlto_bind_to_version = " HILTI_VERSION_FUNCTION_STRING "();");
