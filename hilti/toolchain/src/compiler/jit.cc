...
by opening a ticket at https://github.com/zeek/spicy/issues.

Please include the content of the file %s in your
report; it contains diagnostics from the C++ compiler. Please also
