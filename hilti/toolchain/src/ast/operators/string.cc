...
is not found, the returned vector will have the whole string value as its single
...
returned tuple will have the whole string value as its first element and an empty value
