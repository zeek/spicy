...
public:
     ...
     */
    void connect_mime_type(const hilti::rt::String& mt, uint64_t scope) { connect_mime_type(MIMEType(mt), scope); }
    ...
    void connect_mime_type(const hilti::rt::Bytes& mt, uint64_t scope) {
        connect_mime_type(MIMEType(mt.decode(hilti::rt::unicode::Charset::ASCII)), scope);
    }
