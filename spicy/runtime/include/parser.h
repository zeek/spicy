 ...
 */
struct Parser {
    Parser(::hilti::rt::struct_::Args, std::string_view name, bool is_public, Parse1Function parse1,
    ...
    Parser(::hilti::rt::struct_::Args, std::string_view name, bool is_public, hilti::rt::Null /* null */,
           hilti::rt::any parse2, hilti::rt::Null /* null */, hilti::rt::Null /* null */,
           const hilti::rt::TypeInfo* type, std::string description, hilti::rt::Vector<MIMEType> mime_types,
           hilti::rt::Vector<ParserPort> ports)
        : Parser(::hilti::rt::struct_::Args(), name, is_public, nullptr, std::move(parse2), nullptr, nullptr, type,
    ...
    Parser(::hilti::rt::struct_::Args, std::string_view name, bool is_public, hilti::rt::Null /* null */,
           ...
           const hilti::rt::TypeInfo* type, std::string description, hilti::rt::Vector<MIMEType> mime_types,
           hilti::rt::Vector<ParserPort> ports)
        : Parser(::hilti::rt::struct_::Args(), name, is_public, nullptr, std::move(parse2), nullptr, context_new, type,
                 std::move(description), std::move(mime_types), std::move(ports)) {
        _initProfiling();
    }
