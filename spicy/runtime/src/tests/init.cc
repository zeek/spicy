...
TEST_CASE("init") {
    ...
    SUBCASE("single parser") {
        const Parser parser(hilti::rt::struct_::Args(), "Parser", true, Parse1Function(), Parse2Function<int>(),
    ...
    SUBCASE("multiple parsers, all 'public'") {
        const Parser parser1(hilti::rt::struct_::Args(), "Parser1", true, Parse1Function(), Parse2Function<int>(),
                             Parse3Function(), nullptr, nullptr, "Parser1: description", {MIMEType("foo/bar")},
                             {ParserPort{hilti::rt::tuple::make(hilti::rt::Port(4040, hilti::rt::Protocol::TCP),
                                                                Direction::Originator)}});
        const Parser parser2(hilti::rt::struct_::Args(), "Parser2", true, Parse1Function(), Parse2Function<int>(),
    ...
    SUBCASE("multiple parsers, just one 'public'") {
        const Parser parser1(hilti::rt::struct_::Args(), "Parser1", true, Parse1Function(), Parse2Function<int>(),
                             ...
                             {ParserPort{hilti::rt::tuple::make(hilti::rt::Port(4040, hilti::rt::Protocol::TCP),
                                                                Direction::Originator)}});
        const Parser parser2(hilti::rt::struct_::Args(), "Parser2", false, Parse1Function(), Parse2Function<int>(),
                             Parse3Function(), nullptr, nullptr, "Parser2: description", {MIMEType("foo/*")},
                             {ParserPort{hilti::rt::tuple::make(hilti::rt::Port(4040, hilti::rt::Protocol::TCP),
                                                                Direction::Responder)}});
        detail::globalState()->parsers.emplace_back(&parser1);
