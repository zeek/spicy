...
void SpicyDump::usage() {
    ...
    std::cerr
        << "Usage: cat <data> | spicy-dump [options] <inputs> ...\n"
           ...
           "       --strict-public-api        Skip optimizations that the change public C++ API of generated code.\n"
           "       --no-strict-public-api     Allow optimizations that the change public C++ API of generated code.\n"
           "\n"
